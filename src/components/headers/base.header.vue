<template>
  <section class="text-white flex flex-col sticky top-0 z-30 right-0 top-0">
    <div class="h-16 bg-black">
      ...
      <div class="flex items-center w-11/12 m-auto h-full justify-between">
        ...
        <RouterLink
          :to="{ name: 'HOME' }"
          class="text-xl font-black truncate lg:w-full w-36 "
        >
        ...
        <div class="flex items-center w-full justify-end gap-4">
          ...
          <div class="flex gap-3 relative items-center  ">
            <div
              class="absolute bg-red-500 size-5 flex justify-center items-center rounded-full bottom-3 left-2"
            >
  ...
  <div
    class="bg-white border-t-[1px] w-full overflow-x-scroll overflow-hidden no-scrollbar"
  >
    <BreadcumbHeader />
  </div>
</template>
