...
export const API_URL = {
  ...
  //
  STAGE_LIST: `${BASE_URL}/stagiaires`,
  STAGE_CREATE: `${BASE_URL}/stagiaires/add`,
  STAGE_SHOW: `${BASE_URL}/stagiaires/`,
  STAGE_UPDATE: `${BASE_URL}/stagiaires/update`,
  STAGE_REMOVE: `${BASE_URL}/stagiaires/delete`,
};
