...
export const routeCompta = {
  ...
  children: [
    ...
    {
      path: "facture/versements",
      name: "COMPTA_FACTURE_PAID",
      component: () => import("@/pages/comptabilites/facture_paid_compta.page.vue"),
      children: [],
    },
    {
      path: "compte",
    ...
    },
    {
      ...
      component: () =>
        import("@/pages/comptabilites/compte_transaction_compta.page.vue"),
      children: [],
    },
    {
      path: "livre",
