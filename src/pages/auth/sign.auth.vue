...
<template>
   <section class="flex justify-center items-center h-[100vh] flex-col gap-8 ">
      ...
      <div class="fixed inset-0 "> <img class="w-full h-full object-cover"
                  ...
                  <div>
                     ...
                     <CardContent class="space-y-2">
                        ...
                        <FormField v-slot="{ componentField }" name="password">
                           <FormItem>
                              ...
                              <FormControl>
                                 <Input type="password" placeholder="Votre mot de passe securisé"
                     ...
                     <CardFooter>
                        <Button class="w-full font-bold">
                           ...
                           <span class="text-base" v-if="!state.loading">Se connecter</span>
                        </Button>
                     </CardFooter>
                  </div>
               </form>
