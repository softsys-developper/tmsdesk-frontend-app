  ...
  <BaseLayout>
    <template v-slot:content>
      <section class="flex flex-col w-full gap-4 bg-white rounded-lg mb-4">
        <ContentLayout
          :title="`Logistique | ${
            $route.query.id ? 'Modification Livraion' : 'Création Livraion'
          }`"
        >
            ...
            <div class="flex w-full flex-col lg:flex-row gap-4">
              <div class="bg-white rounded-md flex flex-col gap-2 w-full">
                  ...
                  <div class="w-full">
                    <div class="flex flex-col w-full gap-3">
                      ...
                      <div class="flex flex-col">
                        <label for="" class="text-sm flex gap-1"
                          >Quantité</label
                        >
                        <input
                          type="text"
                          v-model="service.quantite"
                          placeholder="Ex : 500"
                ...
                <div class="flex w-full m-auto">
                  <span class=""></span>
                  <Button
                    :disabled="service.quantite == '' || 0 ? true : false"
...
const AddServices = (service: any) => {
  ...
  ProductAndServices.value.push({
    ...
    id: ListOfLivraisonServices.value.find(
      (el: any) => el.reference == service.reference
    )?.id,
    produit_service_id: ListOfLivraisonServices.value.find(
      (el: any) => el.reference == service.reference
    )?.id,
