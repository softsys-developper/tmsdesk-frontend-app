          ...
          <template v-slot:created>
            <div class="flex gap-2">
              <RouterLink class="h-10" :to="{ name: 'COMPTA_TRANSACTION' }">
                <button
                  class="bg-blue-500 text-white rounded-lg px-4 h-full font-bold flex gap-1 items-center"
                >
...
const { FindCompteAll, storeComptes, CompteDelete, setCompte } =
  useCompteHook();
