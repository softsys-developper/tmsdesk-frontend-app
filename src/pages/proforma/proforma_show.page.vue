  ...
  <BaseLayout>
    <template v-slot:content>
      <section class="flex flex-col w-full gap-4 bg-white rounded-lg mb-8">
        ...
        <!-- Invoice -->
        <div class="w-full px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10" v-if="Parametres && ProformaShow">
                      ...
                      <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                          <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">New York
                              No. 1 Lake Park</td>
                  ...
                  <div class="w-full max-w-2xl sm:text-end space-y-2">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                      ...
                      <dl class="grid sm:grid-cols-5 gap-x-3">
                        ...
                        <dd class="col-span-2 text-blue-500 dark:text-neutral-500">
